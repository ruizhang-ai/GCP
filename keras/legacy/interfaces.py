...
legacy_recurrent_support = generate_legacy_interface(
    ...
    conversions=[('output_dim', 'units'),
                 ...
                 ('V_regularizer', 'conditional_regularizer'),
                 ('wa_regularizer', 'attention_context_wa_regularizer'),
                 ('Wa_regularizer', 'attention_recurrent_regularizer'),
                 ('Ua_regularizer', 'attention_context_regularizer'),
                 ('ba_regularizer', 'bias_ba_regularizer'),
                 ('dropout_W', 'dropout'),
                 ('dropout_U', 'recurrent_dropout'),
                 ('dropout_V', 'conditional_dropout'),
                 ('dropout_Wa','attention_dropout'),
